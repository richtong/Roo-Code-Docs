...
exports.default = KangarooIcon;
var react_1 = require("react");
function KangarooIcon(props) {
    return (<svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="20" height="20" style={{ display: 'inline', verticalAlign: 'text-bottom', marginRight: '4px' }} {...props}>
